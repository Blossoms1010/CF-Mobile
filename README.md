...
The app uses Judge0 for running code. Default configuration:

```swift
// File: CfEditor/network/Judge0Client.swift
static var `default`: Config {
    Config(baseURL: URL(string: "https://ce.judge0.com")!)
}
```

**Custom Configuration** (Self-hosted or RapidAPI):

```swift
// Self-hosted Judge0 instance
Config(baseURL: URL(string: "https://your-judge0-server.com")!)
...
- Verify Judge0 service is accessible (default: ce.judge0.com)
