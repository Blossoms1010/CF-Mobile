        ...
        private func injectCodeforcesProblemReader(on webView: WKWebView) {
            ...
            (function(){
              try {
                ...
                style.textContent = `
                  :root{ --cf-bg:#ffffff; --cf-text:#0f0f10; --cf-border:rgba(0,0,0,0.15); --cf-sample-bg:#f7f7f7; }
                  @media (prefers-color-scheme: dark){ :root{ --cf-bg:#0c0d0e; --cf-text:#e8e8ea; --cf-border:rgba(255,255,255,0.18); --cf-sample-bg:#141517; } }
                  ...
                  .sample-tests pre { white-space: pre-wrap !important; word-wrap: break-word !important; color: var(--cf-text); }
                  pre, code { color: var(--cf-text); }
                  pre { overflow: auto; -webkit-overflow-scrolling: touch; position: relative; }
                  /* 明确声明暗色/亮色，让内置表单控件与滚动条在暗色时不反白 */
                  :root { color-scheme: light dark; }
                  img { max-width: 100% !important; height: auto !important; background: transparent !important; }
                  /* 防止任何遗留的暗色反色过滤影响渲染 */
                  #cf-reader-container img, #cf-reader-container svg, mjx-container svg { filter: none !important; mix-blend-mode: normal !important; }
