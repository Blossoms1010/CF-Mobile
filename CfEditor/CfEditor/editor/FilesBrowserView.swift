    ...
    var body: some View {
        ...
        .sheet(isPresented: $isRenameSheetPresented, onDismiss: {
            ...
            if let targetURL = renameTargetURL {
                ...
                NavigationStack {
                    ContentUnavailableView("Failed to rename", systemImage: "exclamationmark.triangle", description: Text("please retry"))
        ...
        // 重命名错误提示
        .alert("Failed to rename", isPresented: $showRenameError) {
            Button("confirm") { }
        } message: {
