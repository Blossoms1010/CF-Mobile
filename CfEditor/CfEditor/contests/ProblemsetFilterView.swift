    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                // 显示选项
                Section("显示选项") {
                    Toggle("隐藏已解决的题目", isOn: $tempFilter.hideSolved)
                    Toggle("显示未解决问题的标签", isOn: $tempFilter.showUnsolvedTags)
                }
