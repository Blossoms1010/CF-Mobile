                    ...
                    ToolbarItem(placement: .primaryAction) {
                        Menu {
                            Button(action: copyAllTranslations) {
                                Label("复制全部译文", systemImage: "doc.on.doc")
                            }
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        HStack(spacing: 12) {
                            presetButton(title: "舒适", fontSize: 17, lineHeight: 1.75)
                            presetButton(title: "护眼", fontSize: 18, lineHeight: 1.8)
                            presetButton(title: "紧凑", fontSize: 15, lineHeight: 1.6)
                        }
                    }
                }
                .padding(20)
