              ...
              try {
                ...
                style.textContent = `
                  ...
                  .sample-tests .output > pre {
                    margin: 0; padding: 10px; background: var(--cf-sample-bg) !important;
                  ...
                  @media (prefers-color-scheme: dark){
                    ...
                    .CodeMirror,
                    .ace_editor {
                      background: #1a1a1a !important;  /* 深灰色背景 */
                      background-color: #1a1a1a !important;  /* 确保背景色 */
                      color: #e0e0e0 !important;       /* 浅灰色文字 */
                      border: 1px solid #333333 !important;
                    }
                    
                    /* 为交替行提供轻微的对比度 */
                    .sample-tests .input:nth-child(even),
                    .sample-tests .output:nth-child(even),
